...
if (!$question) {
    ...
    if ($result_score->num_rows == 0) {
        // Insert score
        $insert_score = mysqli_query($conn,"INSERT INTO scores (student_id, topic_2) VALUES('$student_id','$score')");
    } else {
        // Update score
        $update_score = mysqli_query($conn,"UPDATE scores SET topic_2='$score' WHERE student_id='$student_id'");
    }
...
if (isset($_POST['answer'])) {
    ...
    if ($_SESSION['current_question'] > $total_questions_count) {
        ...
        header("Location: Quiz_2.php?topic_id=" . $_SESSION['topic_id']);
        exit();
    }
}
?>
...
<div class="form-container">
    ...
    <form method="POST" action="Quiz_2.php?topic_id=<?php echo $topic_id; ?>">
