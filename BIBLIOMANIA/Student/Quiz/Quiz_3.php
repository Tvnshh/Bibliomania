...
if (!$question) {
    ...
    if ($result_score->num_rows == 0) {
        // Insert score
        $insert_score = mysqli_query($conn,"INSERT INTO scores (student_id, topic_3) VALUES('$student_id','$score')");
    } else {
        // Update score
        $update_score = mysqli_query($conn,"UPDATE scores SET topic_3='$score' WHERE student_id='$student_id'");
    }
