...
$topic_id = isset($_GET['topic_id']) ? $_GET['topic_id'] : 'T004'; // Default to 'T001' if not provided
...
if (isset($_POST['answer'])) {
    ...
    if ($_SESSION['current_question'] > $total_questions_count) {
        ...
        header("Location: Quiz_4.php?topic_id=" . $_SESSION['topic_id']);
        exit();
    }
}
?>
...
<div class="form-container">
    ...
    <form method="POST" action="Quiz_4.php?topic_id=<?php echo $topic_id; ?>">
...
if (!$question) {
    ...
    if ($result_score->num_rows == 0) {
        // Insert score
        $insert_score = mysqli_query($conn,"INSERT INTO scores (student_id, topic_4) VALUES('$student_id','$score')");
    } else {
        // Update score
        $update_score = mysqli_query($conn,"UPDATE scores SET topic_4='$score' WHERE student_id='$student_id'");
    }
...
if (isset($_POST['answer'])) {
    ...
    if ($_SESSION['current_question'] > $total_questions_count) {
        ...
        if ($topic_id === 'T001') {
            ...
            $topic_column = 'topic_3';
        } elseif ($topic_id === 'T004') {
            $topic_column = 'topic_4';
        }
