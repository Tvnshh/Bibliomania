...
$topic_id = isset($_GET['topic_id']) ? $_GET['topic_id'] : 'T003'; // Default to 'T001' if not provided
...
if (!$question) {
    ...
    if ($result_score->num_rows == 0) {
        // Insert score
        $insert_score = mysqli_query($conn,"INSERT INTO scores (guest_id, topic_4) VALUES('$guest_id','$score')");
    } else {
        // Update score
        $update_score = mysqli_query($conn,"UPDATE scores SET topic_4='$score' WHERE guest_id='$guest_id'");
    }
