...
if (!$question) {
    ...
    if ($result_score->num_rows == 0) {
        // Insert score
        $insert_score = mysqli_query($conn,"INSERT INTO scores (guest_id, topic_3) VALUES('$guest_id','$score')");
    } else {
        // Update score
        $update_score = mysqli_query($conn,"UPDATE scores SET topic_3='$score' WHERE guest_id='$guest_id'");
    }
...
if (isset($_POST['answer'])) {
    ...
    if ($_SESSION['current_question'] > $total_questions_count) {
        ...
        header("Location: Quiz_3.php?topic_id=" . $_SESSION['topic_id']);
        exit();
    }
}
?>
...
<div class="form-container">
    ...
    <form method="POST" action="Quiz_3.php?topic_id=<?php echo $topic_id; ?>">
